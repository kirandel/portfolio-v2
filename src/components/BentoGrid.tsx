    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <div 
            data-box="1"
            className="rounded-3xl p-6 flex flex-col justify-between relative overflow-hidden cursor-pointer transition-all duration-500 ease-out min-h-[624px] md:min-h-[600px]"
            style={{
          ...
          >
            ...
            <div 
              className={`absolute top-[114px] md:top-[90px] left-0 right-0 bottom-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 1 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
...
Australia Launch
          ...
          <div 
            data-box="3"
            className="rounded-3xl p-6 relative overflow-hidden cursor-pointer transition-all duration-500 ease-out min-h-[624px] md:min-h-[600px]"
            style={{
...
Carculator
          ...
          <div 
            data-box="5"
            className="rounded-3xl p-6 flex flex-col relative overflow-hidden cursor-pointer transition-all duration-500 ease-out min-h-[624px] md:min-h-[600px]"
            style={{
