      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          >
            ...
            <div 
              className={`absolute top-[114px] md:top-[90px] left-0 right-0 bottom-0 pb-[40px] md:pb-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 1 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
...
Australia Launch
            ...
            {/* Phone mockup image - fades out on hover */}
            <div 
              className={`absolute top-[114px] md:top-[90px] left-0 right-0 bottom-0 pb-[40px] md:pb-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 2 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
...
Revenue Sharing
            ...
            {/* Phone mockup image - fades out on hover */}
            <div 
              className={`absolute top-[114px] md:top-[90px] left-0 right-0 bottom-0 pb-[40px] md:pb-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 3 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
...
Carculator
            ...
            {/* Phone mockup image - fades out on hover */}
            <div 
              className={`absolute top-[114px] md:top-[90px] left-0 right-0 bottom-0 pb-[40px] md:pb-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 4 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
          ...
          >
            ...
            {/* Phone mockup image - fades out on hover */}
            <div 
              className={`absolute top-[114px] md:top-[90px] left-0 right-0 bottom-0 pb-[40px] md:pb-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 5 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
          ...
          >
            ...
            {/* Phone mockup image - fades out on hover */}
            <div 
              className={`absolute top-[114px] md:top-[90px] left-0 right-0 bottom-0 pb-[40px] md:pb-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 6 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
          ...
          >
            ...
            {/* Phone mockup image - fades out on hover */}
            <div 
              className={`absolute top-[114px] md:top-[90px] left-0 right-0 bottom-0 pb-[40px] md:pb-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 7 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
          ...
          >
            ...
            {/* Phone mockup image - fades out on hover */}
            <div 
              className={`absolute top-[114px] md:top-[90px] left-0 right-0 bottom-0 pb-[40px] md:pb-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 8 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
          ...
          >
            ...
            {/* Phone mockup image - fades out on hover */}
            <div 
              className={`absolute top-[114px] md:top-[90px] left-0 right-0 bottom-0 pb-[40px] md:pb-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 9 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
