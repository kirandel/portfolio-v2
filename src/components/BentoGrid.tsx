      ...
      <div className="max-w-[1536px] mx-auto">
        ...
        >
          ...
          >
            ...
            <div 
              className={`absolute top-[114px] md:top-[102px] left-0 right-0 bottom-0 overflow-hidden transition-all duration-500 z-10 ${hoveredTile === 1 ? 'opacity-0' : 'opacity-100'}`}
            >
              <img 
