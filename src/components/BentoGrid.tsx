    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <div 
            data-box="1"
            className="rounded-3xl p-6 flex flex-col justify-between relative overflow-hidden cursor-pointer transition-all duration-500 ease-out min-h-[634px] md:min-h-[600px]"
            style={{
...
Australia Launch
          ...
          <div 
            data-box="3"
            className="rounded-3xl p-6 relative overflow-hidden cursor-pointer transition-all duration-500 ease-out min-h-[634px] md:min-h-[600px]"
            style={{
...
Carculator
          ...
          <div 
            data-box="5"
            className="rounded-3xl p-6 flex flex-col relative overflow-hidden cursor-pointer transition-all duration-500 ease-out min-h-[634px] md:min-h-[600px]"
            style={{
