      ...
      <div className="max-w-[1536px] mx-auto">
        ...
        >
          ...
          >
            ...
            <div className={`absolute top-28 left-6 right-6 bottom-6 transition-all duration-500 z-10 overflow-y-auto ${hoveredTile === 1 ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
